const menu = [
    {
        ...
        image: "http://localhost:5000/images/post1.jpg",
        ingredients: ["Dolci", "Torte", "Ricette vegetariane", "Ricette al forno"],
    },
    {
        id: 2,
        ...
        content: `I cracker alla barbabietola sono uno snack stuzzicante e originale da preparare in casa utilizzando ingredienti semplici e genuini. Queste sfogliette dal colore brillante non passeranno inosservate nel vostro cestino del pane e arricchiranno la tavola con il loro gusto unico e accattivante. I cracker fatti a mano sono anche un gustoso snack spezza fame, da portare in ufficio o a scuola. Venite a scoprire il nostro mix di semi e cereali per realizzare l'impasto e divertitevi a sperimentare nuove ricette di cracker variando i semi, le farine e le spezie per gusti sempre nuovi, ecco qualche idea:
                  ...
                  Cracker ai semi`,
        image: "http://localhost:5000/images/post2.jpg",
        ingredients: ["Antipasti", "Ricette vegetariane", "Ricette al forno"],
    },
    {
        id: 3,
        name: "Pasta barbabietola e gorgonzola",
        ...
        image: "http://localhost:5000/images/post4.jpg",
        ingredients: ["Primi piatti", "Ricette vegetariane"],
    },
    {
        id: 4,
        ...
        image: "http://localhost:5000/images/post3.jpg",
        ingredients: ["Dolci", "Dolci veloci", "Ricette veloci", "Ricette vegetariane"],
    },
    {
        id: 5,
        name: "Torta paesana",
        ...
        image: "http://localhost:5000/images/post5.jpg",
        ingredients: ["Dolci", "Dolci al cioccolato", "Torte", "Ricette vegetariane", "Ricette al forno"],
    },
];
